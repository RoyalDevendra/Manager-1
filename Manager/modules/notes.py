...
from manager import LOGGER, JOIN_LOGGER, SUPPORT_CHAT, dispatcher, DRAGONS
...
from manager.modules.helper_funcs.string_handling import escape_invalid_curly_brackets
